      ...
      <div className="container max-w-sm mx-auto pt-[50px]">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 dark:text-white">
            ...
            <div>
              <h3 className="text-[18px] font-medium leading-[22px]">
                Nurzod Mardiyev
              </h3>
              <p>Hayirli kun!</p>
            </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center justify-between bg-white dark:bg-gray-900 dark:text-white p-[10px]  rounded-xl mb-2">
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-center bg-gradient-to-tl from-[#003EFF] to-[#0094FF] w-[40px] h-[40px] rounded-full">
                  <LuMoveRight className="text-[20px] text-white" />
                </div>
                <span>
